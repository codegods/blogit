...
const shouldInlineRuntimeChunk = true; // TODO: Make this configurable with config.py
...
module.exports = function(webpackEnv) {
  ...
  return {
    ...
    entry: [
      ...
      // Finally, this is our app's code:
      paths.appIndexJs,
    ].filter(Boolean),
    output: {
      // The build folder.
        ...
        new TerserPlugin({
          terserOptions: {
            parse: {
              ...
              // to apply any minification steps that turns valid ecma 5 code into invalid ecma 5 code.
              ecma: 8,
            },
            compress: {
              ecma: 5,
    ...
    plugins: [
      ...
      isEnvProduction &&
        new WorkboxWebpackPlugin.GenerateSW({ // TODO: Change to InjectManifest
          clientsClaim: true,
