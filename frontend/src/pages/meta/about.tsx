    ...
    return (
      <Container className={classes.root}>
        ...
        <p className={classes.social}>
          <img
            alt="Blogit's star count on GitHub"
            src="https://img.shields.io/github/stars/codegods/blogit?style=social"
          />
          <img
            alt="Blogit's watch count on GitHub"
            src="https://img.shields.io/github/watchers/codegods/blogit?style=social"
          />
        </p>
      </Container>
    );
